...
internal sealed class NativeAudioSettings : MonoBehaviour
{
    ...
    private RectTransform? rowRect, parentRect, previousRect;
    private readonly Vector3[] corners = new Vector3[4];

    internal static void Attach(GameAudioSettings audio, Toggle lastControl)
    {
        ...
        GuiDropdown? template = settings.GetComponentsInChildren<GuiDropdown>(true).FirstOrDefault();
    ...
    private void Create(GameAudioSettings audio, Toggle lastControl, GuiDropdown template, TMP_Text font)
    {
        ...
        Label(row.transform, font, "Output device", 0, 0, 0.42f, 40);
    ...
    {
        private static void Postfix(GameAudioSettings __instance, Toggle ___m_continousMusic) => Attach(__instance, ___m_continousMusic);
    }
